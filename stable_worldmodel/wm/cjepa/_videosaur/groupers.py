"""SlotAttention grouper, vendored from martius-lab/videosaur (MIT License).

Source: videosaur/modules/groupers.py — verbatim aside from dropping the
YAML-driven `build()` function, which this project does not use (see
../videosaur_encoder.py for direct construction).
"""
